...
class sfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function configure()
  {
    ...
    $this->widgetSchema['sf_guard_user_group_list']->setLabel('Grupos');
    $this->widgetSchema['sf_guard_user_permission_list']->setLabel('Permisos');
    $this->widgetSchema['is_active']->setLabel('Activo');
    $this->widgetSchema['is_super_admin']->setLabel('SuperAdmin');
