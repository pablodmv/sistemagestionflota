...
class LocalidadTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('DISTANCIA', 'Distancia', 'INTEGER', false, null, null);
		$this->addColumn('CAPITAL', 'Capital', 'BOOLEAN', false, null, null);
		$this->addColumn('CIUDADREFERENCIA', 'Ciudadreferencia', 'BOOLEAN', false, null, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Zona', 'Zona', RelationMap::ONE_TO_MANY, array('id' => 'localidad_id', ), null, null);
	} // buildRelations()
