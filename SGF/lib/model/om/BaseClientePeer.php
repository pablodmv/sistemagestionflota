...
abstract class BaseClientePeer {
	...
	const RAZON_SOC = 'cliente.RAZON_SOC';
	...
	const ES_EMPRESA = 'cliente.ES_EMPRESA';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ClientePeer::RAZON_SOC);
		$criteria->addSelectColumn(ClientePeer::RUT);
		...
		$criteria->addSelectColumn(ClientePeer::MAIL);
		$criteria->addSelectColumn(ClientePeer::ES_EMPRESA);
	}
	...
	{
	  return array(array('nombre'), array('rut'));
	}
