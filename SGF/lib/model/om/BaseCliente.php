...
abstract class BaseCliente extends BaseObject  implements Persistent {
	...
	public function setRazonSoc($v)
	{
		...
		if ($this->razon_soc !== $v) {
			$this->razon_soc = $v;
			$this->modifiedColumns[] = ClientePeer::RAZON_SOC;
		}
	...
	public function setRut($v)
	{
		...
		if ($this->rut !== $v) {
			$this->rut = $v;
			$this->modifiedColumns[] = ClientePeer::RUT;
		}
	...
	public function setMail($v)
	{
		...
		if ($this->mail !== $v) {
			$this->mail = $v;
			$this->modifiedColumns[] = ClientePeer::MAIL;
		}
	...
	public function setEsEmpresa($v)
	{
		...
		if ($this->es_empresa !== $v) {
			$this->es_empresa = $v;
			$this->modifiedColumns[] = ClientePeer::ES_EMPRESA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = ClientePeer::NUM_COLUMNS - ClientePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientePeer::RAZON_SOC)) $criteria->add(ClientePeer::RAZON_SOC, $this->razon_soc);
		if ($this->isColumnModified(ClientePeer::RUT)) $criteria->add(ClientePeer::RUT, $this->rut);
		...
		if ($this->isColumnModified(ClientePeer::MAIL)) $criteria->add(ClientePeer::MAIL, $this->mail);
		if ($this->isColumnModified(ClientePeer::ES_EMPRESA)) $criteria->add(ClientePeer::ES_EMPRESA, $this->es_empresa);
	 ...
	 * related Ordens from storage. If this Cliente is new, it will return
		...
		if ($this->collOrdens === null) {
			if ($this->isNew()) {
			   $this->collOrdens = array();
				...
				$criteria->add(OrdenPeer::CLIENTE, $this->id);
	...
	public function addOrden(Orden $l)
	{
		...
		if (!in_array($l, $this->collOrdens, true)) { // only add it if the **same** object is not already associated
			...
			$l->setClienteRelatedByCliente($this);
		}
	}
	 ...
	 */
	public function getOrdensJoinMonedaRelatedByMoneda($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientePeer::DATABASE_NAME);
		}
		...
		if ($this->collOrdens === null) {
			if ($this->isNew()) {
				...
				$this->collOrdens = OrdenPeer::doSelectJoinMonedaRelatedByMoneda($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Cliente has previously been saved, it will retrieve
	 * related Facturas from storage. If this Cliente is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFacturas === null) {
			if ($this->isNew()) {
			   $this->collFacturas = array();
				...
				$criteria->add(FacturaPeer::CLIENTE, $this->id);
	 ...
	 * actually need in Cliente.
	 */
	public function getFacturasJoinMonedaRelatedByMoneda($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientePeer::DATABASE_NAME);
		}
		...
		if ($this->collFacturas === null) {
			if ($this->isNew()) {
				...
				$this->collFacturas = FacturaPeer::doSelectJoinMonedaRelatedByMoneda($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Cliente has previously been saved, it will retrieve
	 * related Tmpfacturas from storage. If this Cliente is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTmpfacturas === null) {
			if ($this->isNew()) {
			   $this->collTmpfacturas = array();
				...
				$criteria->add(TmpfacturaPeer::CLIENTE, $this->id);
	 ...
	 * actually need in Cliente.
	 */
	public function getTmpfacturasJoinMonedaRelatedByMoneda($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ClientePeer::DATABASE_NAME);
		}
		...
		if ($this->collTmpfacturas === null) {
			if ($this->isNew()) {
				...
				$this->collTmpfacturas = TmpfacturaPeer::doSelectJoinMonedaRelatedByMoneda($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
